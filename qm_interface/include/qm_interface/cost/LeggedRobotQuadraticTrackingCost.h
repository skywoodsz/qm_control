...
//        {
//            vector_t uError = vector_t::Zero(30);
//            uError.head(12) = input.head(12) - uNominal.head(12);
//            uError.tail(18) = input.tail(18) - uNominal.tail(18);
//            return {state - xNominal, uError};
//        }
//        else
//        {
//            return {state - xNominal, input - uNominal};
