...
public:
    ...
    vector3_t getEEForce(){ return rbdState_.segment<3>(2 * generalizedCoordinatesNum_ + 7);}
    vector_t getEEPose(){return rbdState_.segment<7>(2 * generalizedCoordinatesNum_); }
protected:
    ...
    void updateArmEE();
    void updateEEForce(const Eigen::Vector3d& force);
